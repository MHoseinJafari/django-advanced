...
class RegistrationApiView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            email_obj = EmailMessage('email/send_email.tpl', {'token': token}, 'admin@admin.com', to=[email])
...
class VerficationEmailApiView(generics.GenericAPIView):
    def get (self, request, *args, **kwargs):
        ...
        token = self.get_tokens_for_user(user_obj)
        email_obj = EmailMessage('email/send_email.tpl', {'token': token}, 'admin@admin.com', to=[self.email])
        EmailThread(email_obj).start()
...
class ActivationApiView(APIView):
    ...
    def get(self, request, token, *args, **kwargs):
        ...
        if user_obj.is_verified:
            return Response({'details': 'your accout has already been verified'})
...
class ActivationResendApiView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        token = self.get_tokens_for_user(user_obj)
        email_obj = EmailMessage('email/send_email.tpl', {'token': token}, 'admin@admin.com', to=[user_obj.email])
        EmailThread(email_obj).start()
